...
<figure>
  <img
    src="https://github.com/user-attachments/assets/d48abb4f-974c-4c31-8f8b-438e248b8701"
  ...
  <figcaption style="text-align: center; margin-top: 0.5rem;">
    <em>AI-powered chat interface allowing teachers to generate math exercises in French, aligned with the Cycle 2 curriculum.</em>
  </figcaption>
</figure>

<figure>
  <img
    src="https://github.com/user-attachments/assets/c90e3cbb-aa6c-4c6f-b6b2-47e5b0feaae8"
    alt="Example of an AI-generated math exercise"
    width="940"
    height="464"
    style="display: block; margin: 0 auto;"
  />
  <figcaption style="text-align: center; margin-top: 0.5rem;">
    <em>Example of an AI-generated math exercise with structured questions and automatically provided correct answers.</em>
  </figcaption>
</figure>

<figure>
  <img
    src="https://github.com/user-attachments/assets/02ae1342-5874-4d85-9c9e-7b15af338cdd"
  ...
  />
  <figcaption style="text-align: center; margin-top: 0.5rem;">
    <em>Teacher dashboard giving access to exam correction, performance analytics, stored results, and curriculum upload.</em>
  </figcaption>
</figure>

<figure>
  <img
    src="https://github.com/user-attachments/assets/155248ac-f444-4f76-98ca-8ed4c2234a8d"
    alt="Exam correction interface"
    width="940"
    height="419"
    style="display: block; margin: 0 auto;"
  />
  <figcaption style="text-align: center; margin-top: 0.5rem;">
    <em>Exam correction interface where teachers upload student exam PDFs for automatic analysis and grading.</em>
  </figcaption>
</figure>

<figure>
  <img
    src="https://github.com/user-attachments/assets/e727c28b-0899-44d7-a69f-b6f6e133d42e"
    alt="Automatically corrected exam"
    width="940"
    height="508"
    style="display: block; margin: 0 auto;"
  />
  <figcaption style="text-align: center; margin-top: 0.5rem;">
    <em>Automatically corrected exam showing validated scores, per-question results, and feedback generated by the system.</em>
  </figcaption>
</figure>

<figure>
  <img
    src="https://github.com/user-attachments/assets/e29e8ec7-23e5-41f5-9e6d-c8c777c0c1ff"
  ...
  />
  <figcaption style="text-align: center; margin-top: 0.5rem;">
    <em>Student performance analytics with personalized recommendations to highlight strengths and learning gaps.</em>
  </figcaption>
</figure>

<figure>
  <img
    src="https://github.com/user-attachments/assets/56e0a387-cdb0-498f-b016-18eeca659de3"
    alt="List of corrected exams"
    width="940"
    height="506"
    style="display: block; margin: 0 auto;"
  />
  <figcaption style="text-align: center; margin-top: 0.5rem;">
    <em>List of corrected exams with saved results, enabling tracking of student performance over time.</em>
  </figcaption>
</figure>
